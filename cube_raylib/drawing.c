...
void draw_point_3d(camera_t cam, vector3_t point, double radius, Color color) {
	...
	vector3_t rotated_point = quaternion_rotate_vector(quaternion_conjugate(cam.orientation), translated_point);
...
void draw_line_3d(camera_t cam, vector3_t point1, vector3_t point2, double thickness, Color color) {
	...
	// Change to cam coordinates
	vector3_t translated_point1 = (vector3_t) {point1.x - cam.position.x, point1.y - cam.position.y, point1.z - cam.position.z};
	vector3_t rotated_point1 = quaternion_rotate_vector(quaternion_conjugate(cam.orientation), translated_point1);
	vector3_t translated_point2 = (vector3_t) {point2.x - cam.position.x, point2.y - cam.position.y, point2.z - cam.position.z};
	vector3_t rotated_point2 = quaternion_rotate_vector(quaternion_conjugate(cam.orientation), translated_point2);
